        ...
        public void Configure(EntityTypeBuilder<Mercaderia> builder)
        {
            builder.HasData
                (
                    ...
                    new Mercaderia { MercaderiaId = 6, 
                        Nombre = "Fajitas de pollo", 
                        TipoMercaderiaId = 1, Precio = 800, 
                    ...
                    new Mercaderia { MercaderiaId = 10, 
                    ...
                    new Mercaderia { MercaderiaId = 11, 
                    ...
                    new Mercaderia { MercaderiaId = 12,
                    ...
                    new Mercaderia { MercaderiaId = 13, 
                    ...
                    new Mercaderia { MercaderiaId = 14, 
                        Nombre = "Carne asada", 
                    ...
                    new Mercaderia { MercaderiaId = 15, 
                    ...
                    new Mercaderia { MercaderiaId = 16, 
                    ...
                    new Mercaderia { MercaderiaId = 17, 
                    ...
                    new Mercaderia { MercaderiaId = 18, 
                        Nombre = "Empanadas", 
                        TipoMercaderiaId = 1, Precio = 800, 
                    ...
                    new Mercaderia { MercaderiaId = 20, 
